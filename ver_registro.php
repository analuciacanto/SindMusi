...
$conteudo = "<center> <a href='index.php'><b> Home </b></a> - 
	  <a href='pesquisa_acervo.php'><b> Voltar à pesquisa no acervo </b></a> </center>";
			...
			if( $registro ){
				...
				$conteudo .= "<center>
								<h3>Registro detalhado</h3>
									...
									Tipo de registro: $tipoReg <br><br>
										
									Mídias $midiasDiv
									
									Título: $tituloReg <br><br>
									...
									Descrição <br>
										<textarea rows='12' cols='100' name='descricaoReg' readonly>$descricaoReg</textarea>
									<br><br>
							 </center>";
			}
			else{
